-- Test technician dashboard real-time updates (fixed)
...
INSERT INTO public.ptl_orders (
  ...
  5,
  'pending',
  '{"scan_boxes": 2, "tester_type": 1}'::jsonb,
  'TEST-QR',
  '1.0',
  '2501'
);
...
INSERT INTO public.board_data (
  ...
  (
    ...
    now(),
    '99999999-9999-9999-9999-999999999999',
    '{"voltage": "5.0V", "frequency": "1MHz"}'::jsonb
  ),
  (
    ...
    now(),
    '99999999-9999-9999-9999-999999999999',
    '{"voltage": "5.1V", "frequency": "1.1MHz"}'::jsonb
  );

-- Insert test scan session with proper jsonb casting
