...
VALUES ('11111111-1111-1111-1111-111111111111', 'MULTI_SESSION_TEST', 'TestBoard', 50, 'in_progress', '3976e4c8-fd06-4b65-b9ca-38622376792a');
...
('22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', '3976e4c8-fd06-4b65-b9ca-38622376792a',
 15, 13, 2, 15, 13, 2,
...
('33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', '3976e4c8-fd06-4b65-b9ca-38622376792a',
 20, 18, 2, 20, 18, 2,
...
('44444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111', '3976e4c8-fd06-4b65-b9ca-38622376792a',
 10, 10, 0, 10, 10, 0,
...
INSERT INTO ptl_orders (id, ptl_order_number, board_type, quantity, status, created_by) 
VALUES ('55555555-5555-5555-5555-555555555555', 'HIGH_FAIL_TEST', 'FailureBoard', 25, 'in_progress', '3976e4c8-fd06-4b65-b9ca-38622376792a');
...
('66666666-6666-6666-6666-666666666666', '55555555-5555-5555-5555-555555555555', '3976e4c8-fd06-4b65-b9ca-38622376792a',
 25, 8, 17, 25, 8, 17,
 now() - interval '90 minutes', now() - interval '30 minutes', 60, 60,
 '{"type": 10, "scanBoxes": 1}', 'completed', false);

-- Test Case 3: Active session with pauses and breaks (using 'paused' status instead of 'break')
INSERT INTO ptl_orders (id, ptl_order_number, board_type, quantity, status, created_by) 
VALUES ('77777777-7777-7777-7777-777777777777', 'ACTIVE_SESSION_TEST', 'ActiveBoard', 100, 'in_progress', '3976e4c8-fd06-4b65-b9ca-38622376792a');
...
('88888888-8888-8888-8888-888888888888', '77777777-7777-7777-7777-777777777777', '3976e4c8-fd06-4b65-b9ca-38622376792a',
 35, 32, 3, 35, 32, 3,
 now() - interval '3 hours', now() - interval '15 minutes', now() - interval '30 minutes',
 150, 120, 15, 15,
 '{"type": 4, "scanBoxes": 6}', 'paused', true);